...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('related_to', 'related_to_component', 'related_to_id')},
            },
        ),
        migrations.CreateModel(
            name='Recommendation',
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('refresh_routes', 'Refresh routes')],
            },
        ),
        migrations.CreateModel(
            name='Opportunity',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', salesforce.fields.SalesforceAutoField(auto_created=True, db_column='Id', primary_key=True, serialize=False, verbose_name='ID')),
                ('subject', salesforce.fields.CharField(blank=True, max_length=255, null=True)),
                ...
                ('owner', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='web.User')),
